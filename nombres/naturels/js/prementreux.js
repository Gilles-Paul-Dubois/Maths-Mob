...
return "m et n SONT premiers entre eux."; else
return "m and n ARE coprimes";
else
if(document.body.className.substring(0,2)=="fr")
return "m et n NE SONT PAS premiers entre eux.";else
return "m and n ARE NOT coprimes";
}
...
document.pgcd.divmn.value=prementreux(parseInt(document.pgcd.getm.value),parseInt(document.pgcd.getn.value) );
}