...
result=result+"Somme des aliquotes: "+A[A.length-1]+"";else
result=result+"Sum of aliquots: "+A[A.length-1]+"";
result=result+" - ";
var x=A[A.length-2];
var y=A[A.length-1];
if (x>y)
if(document.body.className.substring(0,2)=="fr")
result+="Nombre abondant";else 
result+="Abundant number";
if (x<y)
if(document.body.className.substring(0,2)=="fr")
result+="Nombre déficient";else
result+="Deficient number";
if (x==y)
if(document.body.className.substring(0,2)=="fr")
result+="Nombre parfait";else
...
document.diviseurs.erreur.value="No decimal values, please !";
document.diviseurs.divn.value="";
return;
}
...
document.diviseurs.erreur.value="Only non-negative values please !";
document.diviseurs.divn.value="";
return;
}
