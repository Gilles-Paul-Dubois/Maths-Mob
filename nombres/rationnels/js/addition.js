...
function somme(f1,f2)
{ f1=simplif(f1);
f2=simplif(f2);
f3=simplif([f1[0]*f2[1]+f2[0]*f1[1], f1[1]*f2[1]]);
return f3[0]+"/"+f3[1];
}
...
document.pgcd.divmn.value=somme([parseInt(document.pgcd.getm.value),parseInt(document.pgcd.getn.value)],[parseInt(document.pgcd.getp.value),parseInt(document.pgcd.getq.value)] );
}