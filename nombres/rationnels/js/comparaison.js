...
var left=document.pgcd.getm.value+"/"+document.pgcd.getn.value;
var right=document.pgcd.getp.value+"/"+document.pgcd.getq.value;
if(f3[0]<0)
return left+" < "+right;
if(f3[0]==0)
return left+" = "+right;
...
document.pgcd.divmn.value=comp([parseInt(document.pgcd.getm.value),parseInt(document.pgcd.getn.value)],[parseInt(document.pgcd.getp.value),parseInt(document.pgcd.getq.value)] );
}