...
{
    nameSpace1.c = (nameSpace1.a * nameSpace1.f(nameSpace1.b) - nameSpace1.b * nameSpace1.f(nameSpace1.a)) / (nameSpace1.f(nameSpace1.b) - nameSpace1.f(nameSpace1.a));
    nameSpace1.board = JXG.JSXGraph.initBoard('box1', {boundingbox: [nameSpace1.xmin, nameSpace1.ymax, nameSpace1.xmax, nameSpace1.ymin], axis: true});
    ...
    nameSpace1.L=nameSpace1.board.create('line',[nameSpace1.A1,nameSpace1.B1],{strokeSize:1, straightFirst: false, straightLast: false, dash:1})
