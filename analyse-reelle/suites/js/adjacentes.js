...
nameSpace1.Paint = function ()
{
   ...
   { nameSpace1.txt = nameSpace1.board.create('text', [-1, nameSpace1.maxu * 0.9, '&nbsp; suites adjacentes'], {fontSize: 15});}
else
	{ nameSpace1.txt = nameSpace1.board.create('text', [-1, nameSpace1.maxu * 0.9, '&nbsp; adjacent sequences'], {fontSize: 15});}
    nameSpace1.showChart(nameSpace1.board, nameSpace1.n, nameSpace1.offset, nameSpace1.couleur, nameSpace1.u);
    nameSpace1.showChart(nameSpace1.board, nameSpace1.n, -nameSpace1.offset, nameSpace1.couleur2, nameSpace1.v);
}
