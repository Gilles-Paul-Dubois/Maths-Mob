...
{
       if(document.body.className.substring(0,2)=="fr")  
   { return "Valeur de la somme de Riemann : " + nameSpace1.poly.Area().toFixed(2);}
else
 { return "Value of Riemann sum : " + nameSpace1.poly.Area().toFixed(2);}
}

nameSpace1.txt5 = function ()
{
   if(document.body.className.substring(0,2)=="fr")  
   {     return "Valeur de la somme de Riemann : " + nameSpace1.integral1.Value().toFixed(2);}
else
   {     return "Value of Riemann sum : " + nameSpace1.integral1.Value().toFixed(2);}
}
nameSpace1.txt6 = function ()
{
   if(document.body.className.substring(0,2)=="fr")  
   {     var txt = "Type de somme de Riemann : ";}
else
 {     var txt = "Type of Riemann sum : ";}
   if(document.body.className.substring(0,2)=="fr")  
  ...
  {     switch (nameSpace1.choicer)
    {
        ...
        case 4:
            return txt + "value at middle point";
    }}
...
nameSpace1.main = function ()
{
    ...
    switch (nameSpace1.choicer)
    {
        ...
        case 4:
            ...
            nameSpace1.poly = nameSpace1.board.create('polygon', nameSpace1.pointsArray, {withLines: false, fillColor: 'orange', fillOpacity: 0.2, vertices: {visible: false}});// draw polygon like integral
            break;
