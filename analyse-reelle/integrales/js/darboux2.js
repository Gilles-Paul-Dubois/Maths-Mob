...
{
       if(document.body.className.substring(0,2)=="fr")  
   { return "Somme de Darboux supérieure : " + -nameSpace1.poly.Area().toFixed(2);}
else
 { return "Upper Darboux sum : " + -nameSpace1.poly.Area().toFixed(2);}
}

nameSpace1.txt5 = function ()
{
   if(document.body.className.substring(0,2)=="fr")  
   {     return "Somme de Darboux inférieure : " + nameSpace1.integral1.Value().toFixed(2);}
else
  {     return "Lower Darboux sum : " + nameSpace1.integral1.Value().toFixed(2);}
}
...
nameSpace1.main = function ()
{
    ...
    nameSpace1.graph1 = nameSpace1.board.create('functiongraph', [nameSpace1.f1, 1, 8], {color: 'blue'});
    nameSpace1.integral1 = nameSpace1.board.create('integral', [[1, 8], nameSpace1.graph1], {withLabel: false, color: 'blue', fillOpacity: 0.2, curveRight: {visible: false}, curveLeft: {visible: false}});
    nameSpace1.graph2 = nameSpace1.board.create('functiongraph', [nameSpace1.f2, 1, 8], {color:'red'});
    //alternative way to show second integral
    // because normal way not possible WITHOUT ERROR MESSAGE OF ANY KIND !!!
