...
{
    ctx1.width = sizeofelt * 7;
    ctx1.height = sizeofelt * 4;
    ...
    //textzone2.style.width = "350px";
    //textzone2.style.height = "20px";
...
function writeinzone(tz, str)
{
    tz.value = str;
    tz.style.width = 15+str.length*9+"px";
}

function nosetsinside(L)
{
    var i;
...
function Paint()
{
    ...
    CreateElements();
    var nk1 = 2 + Random(5);
    var S1 = new set(nk1, 'E');
    S1.show(ctx1);
    writeinzone(textzone1, parts2(S1.listn));
    writeinzone(textzone2, parts3(S1.listn));
}
