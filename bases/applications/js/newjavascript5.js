...
{
    InitCanvas(c5, 7 * sizeofelt, 7 * sizeofelt);
...
function Paint()
{
    ...
    var R1 = new relgraph(AXB, G1);
    R1.show(c1, "G(f)={");
    R1.saggital(c2);
    R1.showstring(textzone1);
    var BXC = new cart(B, C);
    var G2 = [];
    ...
    var R2 = new relgraph(BXC, G2);
    R2.show(c3, "G(g)={");
    R2.saggital(c4);
    R2.showstring(textzone2);
    var AXC = new cart(A,C);
    var G3=[];
    var p,q, r, s;
    for(i=0;i<A.cardinal;i++)
    {
    ...
    var R3= new relgraph(AXC,G3);
    R3.show(c5,"G(g\u2218f)={");
    R3.saggital(c6);
    R3.showstring(textzone3);
}
Paint();
