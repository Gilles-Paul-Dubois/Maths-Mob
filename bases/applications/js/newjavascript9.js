...
{
    InitCanvas(c4, 7 * sizeofelt, 7 * sizeofelt);

}
function InitCanvas6()
{
    InitCanvas(c6, 7 * sizeofelt, 7 * sizeofelt);

}
function InitTextZone(tz) {
...
function relgraph(C, G)
{
    ...
    this.showstring = function (tz)
    {
        ...
        tz.font = "20px Arial";
        tz.fillStyle = 'black';
        t//z.style.backgroundColor = "#00FF00";
...
function Paint()
{
    ...
    InitCanvas4();
    InitCanvas6();
    InitTextZone(textzone1);
    InitTextZone(textzone2);
    InitTextZone(textzone3);
    var k1 = 3 + Random(4);
    var A = new set(k1, 'E');
    var AXA = new cart(A, A);
    var i, j;
    var G1 = [];
    for (i = 0; i < A.cardinal; i++)
    {
    ...
    var R1 = new relgraph(AXA, G1);
    R1.saggital(c2);
    var R2 = compose(R1, R1);
    R2.saggital(c4);
    var R3 = compose(R1, R2);
    R3.saggital(c6);
    //textzone1.style.backgroundColor = "#00FF00";
    //textzone2.style.backgroundColor = "#00FF00";
    //textzone3.style.backgroundColor = "#00FF00";
    textzone1.value = "  fonction-function f";
    textzone2.value = "  fonction-function f\u2218f";
    textzone3.value = "  fonction-function  f\u2218f\u2218f";
}
