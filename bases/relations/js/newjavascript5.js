...
function relgraph(C, G)
{
    ...
    this.showstring = function (tz)
    {
        ...
        tz.style.width = this.stringtoprint.length * 9 + "px";
...
function reltypestr1(rel)
{
    switch (rel)
    {
        case 0:return "xPy: x a même couleur que y";
        case 1:return "xPy: x a même forme que y";
        case 2:return "xPy: x a un numéro de même parité que y";
  
 
    }
}

function reltypestr2(rel)
{
    switch (rel)
    {
        case 0:return "xPy: x has same color as y";
        case 1:return "xPy: x has same shape as y";
        case 2:return "xPy: x has a number with same parity as y";
    }
...
function Paint(lang)
{
   ...
   if (lang==1) textzone2.value=reltypestr1(reltype);
   if (lang==2) textzone2.value=reltypestr2(reltype);   
    textzone2.style.width = "100%"; 
