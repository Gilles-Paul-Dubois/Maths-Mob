 ...
 this.antecedents=function (j)
    {
        ...
        {
            L.push(this.cartes.E.listel[R[k]]);
        }
        return L;
    }    
    
   
    this.antecedentsstr=function(j)
    {
        var L=this.antecedents(j);
        var n=this.cartes.F.listel[j].name;
        var M=[];
        var k;
    ...
    this.allantecedentsstr=function ()
    {
        var j;
        var L=[];
        for (j=0;j<this.cartes.F.cardinal;j++)
        {
            L.push(this.antecedentsstr(j));
        }
        return L.toString()+" ";
    }    
 
this.showantecedents = function (tz)
    {
