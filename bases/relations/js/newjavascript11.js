...
{
    InitCanvas(c7, 7 * sizeofelt, 7 * sizeofelt);

}
function InitCanvas8()
{
    InitCanvas(c8, 7 * sizeofelt, 7 * sizeofelt);
...
function Paint()
{
    ...
    R.show(c1);
    R.saggital(c2);
    R.showstring(textzone1, "graphe - graph : ");
...
function Paint2()
{
    ...
    R.show(c3);
    R.saggital(c4);
    R.showstring(textzone2, "graphe - graph : ");
}
function Paint3()
{
    InitCanvas5();
    ...
    R.show(c5);
    R.saggital(c6);
    textzone3.font = "20px Arial";
    textzone3.fillStyle = 'black';
    //textzone3.style.backgroundColor = "#00FF00";
    textzone3.value = "graphe - graph : G=ExE";
...
function Paint4()
{
    ...
    R.show(c7);
    R.saggital(c8);
    R.showstring(textzone4, "graphe - graph : ");
