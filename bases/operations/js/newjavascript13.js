...
function Paint()
{
    ...
    F = new relgraph(C, G);
    F.saggital(c3);
    textzone1.style.width = "260px";
    textzone2.style.width = "260px";
    textzone3.style.width = "260px";
    textzone4.style.width = "260px";
    textzone5.style.width = "260px";
    textzone6.style.width = "260px";
    Paint2();
}


function carequ(n, Ens)
{
    return Ens.listel[n].name;
}
...
function formule()
{
    ...
    X = carequ(x, A);
    Y = carequ(y, A);
    var xTy = Op1.table[x * k1 + y];
    var XTY = carequ(xTy, A);
    var i, j, k;
    var fx, fy, fxTy;
    for (i = 0; i < k1; i++)
    {
    ...
    var fXTY = carequ(fxTy, B);
    var fX = carequ(fx, B);
    var fY = carequ(fy, B);

    var fXfY;
    var h = Op2.table[fx + k2 * fy];
    fXfY = carequ(h, B);
    var result = " f(" + X + "T" + Y + ")=f(" + XTY + ")=" + fXTY + "    " + "f(" + X + ")*f(" + Y + ")=" + fX + '*' + fY + "=" + fXfY;
    return result;
}

function Paint2()
{
    textzone1.value = formule();
    textzone2.value = formule();
    textzone3.value = formule();
    textzone4.value = formule();
    textzone5.value = formule();
    textzone6.value = formule();
