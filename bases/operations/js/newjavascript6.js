...
//    m = Op.table[y * k1 + x];
//    final = Op.result(m, z);
//    str1 = "(" + X + Op.signop + Y + ")" + Op.signop + Z + "=" + Op.result(x, y) + Op.signop + Z + "=" + final;
//    m = Op.table[z * k1 + y];
//    final = Op.result(x, m);
//    str2 = X + Op.signop + "(" + Y + Op.signop + Z + ")=" + X + Op.signop + Op.result(y, z) + '=' + final;
//    textzone1.value = str1;
//    textzone2.value = str2;
//    x = 2 + Random(k1 - 2);
//    y = 2 + Random(k1 - 2);
//    z = 2 + Random(k1 - 2);
//    X = A.listel[x].name;
...
function Paint2()
{
    ...
    var v2 = Random(k1);
    var v3 = Random(k1);
    textzone1.value = formula1(Op1, Op2, v1, v2, v3);
    textzone2.value = formula2(Op1, Op2, v1, v2, v3);
