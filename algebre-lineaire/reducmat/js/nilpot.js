...
nameSpace2.zonetexte1.style.width = "50px";
nameSpace2.puissance = 0;
...
nameSpace2.handleClick2 = function (radio) {
    ...
    nameSpace2.type = parseInt(radio.value);
    nameSpace2.Paint();
}
nameSpace2.NextStep = function ()
{   if (nameSpace2.puissance>=nameSpace2.lignes)
        return;
    nameSpace2.puissance++;
    nameSpace2.zonetexte1.value = "n=" + nameSpace2.puissance;
    nameSpace2.B = nameSpace2.B.produit(nameSpace2.A);
...
nameSpace2.Paint = function ()
{
    ...
    switch (nameSpace2.type)
    {
        case 1:
            nameSpace2.A = TSS(nameSpace2.lignes, nameSpace2.choice);
            break;
        case 2:
            nameSpace2.A = TIS(nameSpace2.lignes, nameSpace2.choice);
            break;
        case 3:
            nameSpace2.A = DIA(nameSpace2.lignes, nameSpace2.choice);
            break;
    }
    nameSpace2.A.show(nameSpace2.c1);
    nameSpace2.B = ID(nameSpace2.lignes, nameSpace2.choice);
    nameSpace2.B.show(nameSpace2.c2);
    nameSpace2.zonetexte1.value = "n=" + nameSpace2.puissance;
