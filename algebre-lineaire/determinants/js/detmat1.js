...
{ window.alert("incompatible values")}
    ...
    nameSpace2.A.show(nameSpace2.c1);
       ...
       if(document.body.className.substring(0,2)=="fr")  
   { nameSpace2.zonetexte1.value = "Déterminant de A : "+nameSpace2.A.determinant().string();}
   else {
nameSpace2.zonetexte1.value = "Determinant of A : "+nameSpace2.A.determinant().string();}
}
nameSpace2.Paint();
