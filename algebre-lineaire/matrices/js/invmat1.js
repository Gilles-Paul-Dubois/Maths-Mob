...
nameSpace2.Paint = function ()
{
   ...
   {      window.alert("valeurs incompatibles")
    ...
    nameSpace2.C = nameSpace2.A.produit(nameSpace2.B);
    nameSpace2.C.show(nameSpace2.c3);
       if(document.body.className.substring(0,2)=="fr")  
   { nameSpace2.zonetexte1.value = "Matrice A inversible (régulière)";}
else
{ nameSpace2.zonetexte1.value = "Matrix A is a unit (regular)";}
}
nameSpace2.Paint();
