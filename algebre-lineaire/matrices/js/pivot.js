...
nameSpace2.alert=document.getElementById("alert");
...
{
    if (nameSpace2.choice==2 && (nameSpace2.lignes>3 || nameSpace2.colonnes>3))
    {
   ...
   { nameSpace2.alert.value="Attention ! lignes et colonnes plafonnées à 3 pour les rationnels";}
else
	 { nameSpace2.alert.value="Attention ! rows and columns limted to 3 for rationals.";}     
    }
if (nameSpace2.etape>=Math.min(nameSpace2.lignes,nameSpace2.colonnes))  
    return;
if (nameSpace2.etape==-1)
{
    nameSpace2.A=new pivMatrice(nameSpace2.lignes,nameSpace2.colonnes,nameSpace2.choice);
    nameSpace2.A.show(nameSpace2.c1);
    nameSpace2.A.show(nameSpace2.c2);
}
   else
   {nameSpace2.A.show(nameSpace2.c1);
    nameSpace2.A.step(nameSpace2.etape);
    nameSpace2.A.show(nameSpace2.c2)
   }
