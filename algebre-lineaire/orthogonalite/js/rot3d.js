...
spaceName10.timer;
spaceName10.axrot = 3;
spaceName10.alpha = 30;
spaceName10.range2 = document.getElementById("myRange2");
spaceName10.range2.value = 30;
spaceName10.rad = document.axe;
//spaceName10.zonetexte1=document.getElementById('myText1');
...
spaceName10.initCanvas = function ()
{
    ...
    //spaceName10.zonetexte1.style.width="30px";

}

spaceName10.pyramide = function ()
{
...
spaceName10.computeImage = function (axe, alpha)
{
    switch (axe)
    {
        case 1:

            spaceName10.A1 = spaceName10.A.rotateX(alpha, "A1");
            spaceName10.B1 = spaceName10.B.rotateX(alpha, "B1");
            spaceName10.C1 = spaceName10.C.rotateX(alpha, "C1");
            spaceName10.D1 = spaceName10.D.rotateX(alpha, "D1");
            spaceName10.E1 = spaceName10.E.rotateX(alpha, "E1");
            break;
        case 2:

            spaceName10.A1 = spaceName10.A.rotateY(alpha, "A1");
            spaceName10.B1 = spaceName10.B.rotateY(alpha, "B1");
            spaceName10.C1 = spaceName10.C.rotateY(alpha, "C1");
            spaceName10.D1 = spaceName10.D.rotateY(alpha, "D1");
            spaceName10.E1 = spaceName10.E.rotateY(alpha, "E1");
            break;
        case 3:

            spaceName10.A1 = spaceName10.A.rotateZ(alpha, "A1");
            spaceName10.B1 = spaceName10.B.rotateZ(alpha, "B1");
            spaceName10.C1 = spaceName10.C.rotateZ(alpha, "C1");
            spaceName10.D1 = spaceName10.D.rotateZ(alpha, "D1");
            spaceName10.E1 = spaceName10.E.rotateZ(alpha, "E1");
            break;
    }
...
spaceName10.handleClick = function (radio)
{

    spaceName10.axrot = parseInt(radio.value);
    clearInterval(spaceName10.timer);
    spaceName10.startDemo();
}

spaceName10.changeAlpha = function (val)
{
    spaceName10.alpha = val;
    clearInterval(spaceName10.timer);
    spaceName10.startDemo();
}
...
spaceName10.loop = function ()
{
    ...
    spaceName10.pyramide();
    spaceName10.computeImage(spaceName10.axrot, spaceName10.alpha);
    ...
    //spaceName10.zonetexte1.value=""+spaceName10.alpha;
