...
var textzone1 = document.getElementById("mytext5");
var textzone2 = document.getElementById("mytext6");
...
function loop()
{
    ...
    if (libre())
    {
        ...
        det = A.x * (B.y * C.z - B.z * C.y) - A.y * (B.x * C.z - B.z * C.x) + A.z * (B.x * C.y - B.y * C.x);
        textzone1.value = "(u|v|w)=" + Math.round(det * 100) / 100;

    }
    else
    {
        det = 0;
        textzone1.value = "(u|v|w)=0";
    }
