...
spaceName10.loop = function ()
{
    ...
    //spaceName10.textzone1.value = "OM=u+v+w" + "  " + "O" + G.stringCoords();
    // spaceName10.textzone3.value = A.stringCoords() + "=" + A.x + "i" + " " + B.stringCoords() + "=" + B.y + "j" + " " + C.stringCoords() + "=" + C.z + "k";
