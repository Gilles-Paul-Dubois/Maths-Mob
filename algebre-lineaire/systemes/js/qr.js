...
{
    if (nameSpace2.step > 2)
        return;
    nameSpace2;
    nameSpace2.step++;
    var V = new Vecteur(4, 1, nameSpace2.A.M[nameSpace2.step]);
...
nameSpace2.Paint = function ()
{
    ...
    nameSpace2.B = new Matrice(0, 4, 1);
    nameSpace2.B.M = [];
    nameSpace2.B.lignes = 0;
    nameSpace2.B.colonnes = 4;
    nameSpace2.B.M = [];
    var i;
    for (i = 0; i < 4; i++)
        nameSpace2.NextStep();
    nameSpace2.B.show(nameSpace2.c2);
    nameSpace2.C = MR(4, nameSpace2.choice);
    //nameSpace2.C = nameSpace2.B.produit(nameSpace2.B.transpose());
    nameSpace2.C.show(nameSpace2.c3);
    nameSpace2.A=nameSpace2.B.produit(nameSpace2.C);
