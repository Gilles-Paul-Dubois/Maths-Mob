...
nameSpace2.Paint = function ()
{
    if (nameSpace2.A != null)
        nameSpace2.A = null;
    if (nameSpace2.P != null)
        nameSpace2.P = null;
    if (nameSpace2.L != null)
        nameSpace2.L = null;
    if (nameSpace2.U != null)
        nameSpace2.U = null;
    nameSpace2.P = ID(nameSpace2.lignes, nameSpace2.choice).linesShuffle();
    nameSpace2.P.show(nameSpace2.c2);
    nameSpace2.U = MU(nameSpace2.lignes, nameSpace2.choice);
    nameSpace2.U.show(nameSpace2.c4);
    nameSpace2.L = ML(nameSpace2.lignes, nameSpace2.choice);
    nameSpace2.L.show(nameSpace2.c3);
    nameSpace2.A=nameSpace2.P.produit(nameSpace2.L.produit(nameSpace2.U));
