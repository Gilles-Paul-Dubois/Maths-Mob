...
nameSpace13.M = nameSpace13.board.create('glider', [2.35, -1.5, nameSpace13.D], {size: 1, name: 'M'});
...
nameSpace13.AB=nameSpace13.board.create('line',[nameSpace13.N3, nameSpace13.N4],{color:'green', name:'Polaire', withLabel:false});
...
nameSpace13.MF = nameSpace13.board.create('line', [nameSpace13.M, nameSpace13.F], {color: 'brown'});

nameSpace13.R=nameSpace13.board.create('intersection',[nameSpace13.MF,nameSpace13.P,0],{size:1, color:'blue', name:'R'})
nameSpace13.S=nameSpace13.board.create('intersection',[nameSpace13.MF,nameSpace13.P,1],{size:1, color:'blue', name:'S'})
