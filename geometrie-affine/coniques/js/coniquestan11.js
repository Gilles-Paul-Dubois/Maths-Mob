...
nameSpace11.sla = nameSpace11.board.create('slider', [[-4, -3.5], [-2, -3.5], [1, 3, 4]], {snapWidth: 0.1, withLabel: false});
nameSpace11.slb = nameSpace11.board.create('slider', [[-4, -4], [-2, -4], [1, 2, 4]], {snapWidth: 0.1, withLabel: false});
...
nameSpace11.M = nameSpace11.board.create('point', [2, 3], {size: 1, name:'M<sub>0</sub>'});
...
nameSpace11.M2=nameSpace11.board.create('glider', [nameSpace11.E], {size:1, name:"M<sub>1</sub>"});
nameSpace11.T3=nameSpace11.board.create('tangent',[nameSpace11.M2],{color:'red'});
