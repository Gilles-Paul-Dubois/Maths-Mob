...
nameSpace4.M=nameSpace4.board.create('glider',[nameSpace4.E], {size:1, name:'M'});
nameSpace4.T=nameSpace4.board.create('tangent',[nameSpace4.M],{color:'red'});
nameSpace4.N=nameSpace4.board.create('normal',[nameSpace4.E,nameSpace4.M],{color:'red'});
nameSpace4.MF1=nameSpace4.board.create('line', [nameSpace4.M,nameSpace4.F1], {color:'brown'});
nameSpace4.MF2=nameSpace4.board.create('line', [nameSpace4.M,nameSpace4.F2], {color:'brown'});
nameSpace4.F1F2=nameSpace4.board.create('line', [nameSpace4.F1, nameSpace4.F2], {visible:false});
nameSpace4.G=nameSpace4.board.create('intersection',[nameSpace4.F1F2,nameSpace4.N], {size:1, name:''});
nameSpace4.alpha1=nameSpace4.board.create('angle', [nameSpace4.G, nameSpace4.M, nameSpace4.F1], {name:'&alpha;'});
nameSpace4.alpha2=nameSpace4.board.create('angle', [nameSpace4.F2, nameSpace4.M, nameSpace4.G], {name:'&alpha;'});
