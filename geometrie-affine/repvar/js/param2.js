...
//nameSpace2.textzone1 = document.getElementById("mytext1");// zone to show some data you can create many
nameSpace2.range1 = document.getElementById("myRange1");
nameSpace2.range1.value = 1;
nameSpace2.range2 = document.getElementById("myRange2");
nameSpace2.range2.value = 1;
...
nameSpace2.markpoints = function ()
{
    ...
    nameSpace2.Q.markName(nameSpace2.ctx, nameSpace2.anglex, nameSpace2.angley, nameSpace2.anglez, 'white', nameSpace2.fov, nameSpace2.viewDistance, nameSpace2.viewWidth, nameSpace2.viewHeight);
...
{   // constructor: face = function (vertices, visible, col, thickness, arrowend, close, fill, transparency)
    ...
    function createQ()
    {
        ...
        var Y=y+h*uy+k*vy;
        var Z=z+h*uz+k*vz;
        nameSpace2.Q=new Point3D(X,Y,Z,'Q');
        nameSpace2.PQ=new face([nameSpace2.P,nameSpace2.Q],true, 'white', 1, true, false, false, 1);
    }
    ...
    createQ();
    nameSpace2.universe.push(nameSpace2.PQ);
