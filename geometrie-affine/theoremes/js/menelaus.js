...
nameSpace1.EF = nameSpace1.board.create('line', [nameSpace1.E, nameSpace1.F], {straightFirst: false, straightLast: false, color: 'blue', name: 'EF', withLabel: false});
nameSpace1.DE = nameSpace1.board.create('line', [nameSpace1.D, nameSpace1.E], {straightFirst: false, straightLast: false, color: 'blue', name: 'DE', withLabel: false});
nameSpace1.DF = nameSpace1.board.create('line', [nameSpace1.D, nameSpace1.F], {straightFirst: false, straightLast: false, color: 'blue', name: 'DF', withLabel: false});
